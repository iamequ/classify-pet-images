...
def calculates_results_stats(results_dic):
    ...
    for dog in results_dic:
        if results_dic[dog][3] and results_dic[dog][4]:
            A += 1

        if results_dic[dog][3]:
            B += 1

        if (not results_dic[dog][3]) and (not results_dic[dog][4]):
            C += 1

        if not results_dic[dog][3]:
            D += 1

        if results_dic[dog][2] and results_dic[dog][3]:
            E += 1

        if results_dic[dog][2]:
            Y += 1
